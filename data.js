...
const APEX_DATA = {
        ...
        asymmetries: [
            {
                ...
                solution: "شروع همیشه از پای چپ، به اضافه ۱ ست اضافه مکث کششی ۳ ثانیه‌ای فقط برای پای چپ."
            },
            {
    ...
    // Realistic Iranian Athletic Diet: Chicken, Rice, Potato, Eggs
    nutritionPlan: [
        {
            id: "meal_1",
    ...
    workouts: [
        {
            ...
            exercises: [
                ...
                {
                    id: "ex_1_5",
                    nameFa: "ساق پا تک‌پا با دمبل (تمرکز اصلاحی روی پای چپ)",
                    ...
                    formCues: [
                        ...
                        "در انتهای ۴ ست، ۱ ست مازاد ۱۵ تکراری فقط برای پای چپ با مکث ۳ ثانیه‌ای اجرا کنید."
                    ],
                    startingWeight: "۱۲",
                    progressionStep: 2.0
                },
    ...
    // Biphasic sleep, supplements, and guidance
    longevity: {
        sleepGuidance: [
            "فاز اول (۲۳:۴۵ تا ۴:۰۰): ۴ ساعت و ۱۵ دقیقه خواب عمیق ترمیم فیزیکی و ترشح هورمون رشد.",
            "بازه مناجات (۴:۰۰ تا ۶:۰۰): نور اتاق فقط ملایم زرد باشد. نوشیدن آب ولرم.",
            "فاز دوم (۶:۰۰ تا ۷:۴۵): ۱ ساعت و ۴۵ دقیقه خواب REM جهت تمرکز شناختی و یادگیری حرکتی پدل."
        ],
        supplements: [
            { name: "کراتین مونوهیدرات", dose: "۵ گرم در روز", timing: "همراه وعده ناهار یا بعد تمرین با آب کافی" },
            ...
            { name: "منیزیم بایس‌گلیسینات", dose: "۳۰۰ میلی‌گرم", timing: "۳۰ دقیقه قبل خواب اول (ساعت ۲۳:۰۰)" },
